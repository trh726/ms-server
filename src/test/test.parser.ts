...
const testData = [
  {
    ...
    "@graph": [
      ...
      },
      {
        "@type": "ImageObject",
        "@id":
          "https://kalynskitchen.com/twice-baked-cauliflower-recipe/#primaryimage",
        inLanguage: "en-US",
        url:
          "https://kalynskitchen.com/wp-content/uploads/2017/09/2-550-twice-baked-cauliflower-1.jpg",
        width: 550,
        height: 825,
      },
      {
        "@type": "WebPage",
        "@id":
          "https://kalynskitchen.com/twice-baked-cauliflower-recipe/#webpage",
        url: "https://kalynskitchen.com/twice-baked-cauliflower-recipe/",
        name:
          "Low-Carb Twice-Baked Cauliflower (Video) &ndash; Kalyn&#039;s Kitchen",
        isPartOf: {
          "@id": "https://kalynskitchen.com/#website",
        },
        primaryImageOfPage: {
        ...
        description:
          "Low-Carb Twice-Baked Cauliflower is a side dish that the entire family will love, and this tasty cauliflower dish is also Keto and gluten-free.",
        inLanguage: "en-US",
        potentialAction: [
          {
            "@type": "ReadAction",
      ...
      },
      {
        "@type": "Article",
        "@id":
          "https://kalynskitchen.com/twice-baked-cauliflower-recipe/#article",
        isPartOf: {
          "@id":
            "https://kalynskitchen.com/twice-baked-cauliflower-recipe/#webpage",
        },
        author: {
          "@id":
            "https://kalynskitchen.com/#/schema/person/9e3983ea9544844fae388c70431126e7",
        },
        ...
        articleSection:
          "Can Freeze,Casseroles,Easy to Cook,Favorites,Holiday Recipes,Kid Friendly,Recipes,Side Dishes,Thanksgiving,Video,Weekend Food Prep",
        inLanguage: "en-US",
        potentialAction: [
          {
            "@type": "CommentAction",
    ...
    recipeInstructions: [
      {
        ...
        url:
          "https://kalynskitchen.com/twice-baked-cauliflower-recipe/#mv_create_12_1",
      },
      {
        "@type": "HowToStep",
        ...
        url:
          "https://kalynskitchen.com/twice-baked-cauliflower-recipe/#mv_create_12_2",
      },
      {
        "@type": "HowToStep",
        text:
        ...
        url:
          "https://kalynskitchen.com/twice-baked-cauliflower-recipe/#mv_create_12_3",
      },
      {
        "@type": "HowToStep",
        text:
        ...
        url:
          "https://kalynskitchen.com/twice-baked-cauliflower-recipe/#mv_create_12_4",
      },
      {
        "@type": "HowToStep",
        text:
        ...
        url:
          "https://kalynskitchen.com/twice-baked-cauliflower-recipe/#mv_create_12_5",
      },
      {
        "@type": "HowToStep",
        text:
        ...
        url:
          "https://kalynskitchen.com/twice-baked-cauliflower-recipe/#mv_create_12_6",
      },
      {
        "@type": "HowToStep",
        text:
        ...
        url:
          "https://kalynskitchen.com/twice-baked-cauliflower-recipe/#mv_create_12_7",
      },
      {
        "@type": "HowToStep",
        text:
        ...
        url:
          "https://kalynskitchen.com/twice-baked-cauliflower-recipe/#mv_create_12_8",
      },
      {
        "@type": "HowToStep",
        ...
        url:
          "https://kalynskitchen.com/twice-baked-cauliflower-recipe/#mv_create_12_9",
      },
      {
        "@type": "HowToStep",
        ...
        url:
          "https://kalynskitchen.com/twice-baked-cauliflower-recipe/#mv_create_12_10",
      },
      {
        "@type": "HowToStep",
        text:
        ...
        url:
          "https://kalynskitchen.com/twice-baked-cauliflower-recipe/#mv_create_12_11",
      },
    ],
...
const recipe = new RecipeParser(testData);

export const testRecipe = () => {
  return new RecipeParser(testData);
};
